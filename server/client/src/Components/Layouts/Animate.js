...
export default function AnimationsMenu() {
	...
	const [currentOptions, setCurrentOptions] = React.useState(false)
        ...
        <Grid container className={classes.root} spacing={2}>
            <Grid item xs={6}>
                    ...
                    <Typography variant="h6" style={{color: "#fff"}}>
                     ...
                     <Grid item xs={6}>
                        <Button onClick={() => setCurrentOptions('static')} variant="contained" color="primary"  size="small" className={classes.button}>
                        ...
                        <Grid item xs={6}>
                        <Button onClick={() => setCurrentOptions('spark')} variant="contained" color="primary" size="small" className={classes.button}>
                    ...
                    <Paper style={styles.Paper}>
                      {
                        currentOptions == 'static' ? 'static body' :
                        currentOptions == 'spark' ? 'spark body' : null
                      }
                    <Typography variant="h6" style={{color: "#fff"}}>
                        Options
                    </Typography>
